...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div style="display:inline-block;height:100vh !important;min-height:100% !important;background-color:rgba(104,64,217,0.84);width:100%;" id="TheMangaPhotosF" runat="server">
        ...
        <asp:TextBox style="float:left;margin-top:12px;margin-left:12px;color:#ffffff;font-size:186%;margin-right:14px !important;" Text="ID" BackColor="Transparent" BorderColor="White" BorderStyle="Dotted" ID="ID" runat="server" Height="36px"></asp:TextBox>
