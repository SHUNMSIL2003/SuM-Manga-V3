...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div style="text-align:center;width:100%;height:fit-content;">
        <a id="ADDB" runat="server" href="#" style="background-color:var(--SuMThemeColor);color:#ffffff;border-radius:16px;height:fit-content;width:fit-content;font-size:160%;"><b>+</b></a>
    </div>
</asp:Content>