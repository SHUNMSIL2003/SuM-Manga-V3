...
namespace SuM_Manga_V3
{
    public partial class Search : System.Web.UI.Page
    {
                ...
                if (TextFS != "Search for..." && string.IsNullOrEmpty(TextFS) == false)
                {
                    ...
                    using (SqlConnection sqlCon = new SqlConnection(@"Server=tcp:summanga.database.windows.net,1433;Initial Catalog=summangasqldatabase;Persist Security Info=False;User ID=summangasqladmin;Password=55878833sqlpass#S;MultipleActiveResultSets=False;Encrypt=True;TrustServerCertificate=False;Connection Timeout=30;"))
                    {
                        ...
                        while (IDs.Count > 0)
                        {
                            ...
                            Result += BuildSearchCard(Cover, Name, CExplorerLink, themecolor, MangaIDF);
                        }
                        sqlCon.Close();
                    }
        ...
        protected string BuildSearchCard(string CoverLink, string MangaName, string ExplorerLink, string MangaTheme, int MID)
        {
            ...
            string RS = divST + "<a style=" + astyle + " href=" + ExplorerLink + "><img src=" + CoverLink + " class=" + sc.ToString() + "animated pulse" + sc.ToString() + " style=" + imgstyle + "><h4 style=" + h4style + ">" + MangaName + "</h3><br style=" + "float:left;" + ">" + PDivST + "<p style=" + "color:#6b6b6b;font-size:74%;" + ">" + GetGarnas(MID) + "</p></div></a></div>" + hr;
            return RS;
        }
