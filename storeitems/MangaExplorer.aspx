...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div id="pfc" runat="server" style="background-color:#6840D9;">
        ...
        <div id="CommentsSecCont" runat="server" class="animated slideDown" style="border:4px rgba(225,225,225,0.75) solid;border-top:4px rgba(0,0,0,0) solid;max-height:90%;border-top-right-radius: 22px;border-top-left-radius:22px;background-color:rgba(255,255,255,0.74);display:none;margin-top:6px;width:100vw;height:fit-content;position:absolute;top:0 !important;padding-top:100vh;z-index:998;">
                <h5 style="color:#fff;padding-top:8px;padding-left:8px;padding-bottom:4px;font-size:96%;margin-top:calc(12px - 100vh);">Comments section</h5>
