...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="" id="pfc" runat="server" style="background-color:var(--SuMThemeColor);margin:0 auto !important;width:100vw !important;height:100vh !important;">
        <div class="animated fadeInDown shadow-sm" id="InfoCardBGForJAVA" style="position:fixed !important;top:0 !important;z-index:999 !important;background-color:var(--SuMDWhite) !important;width:calc(100% - 24px) !important;height:fit-content;border-radius:20px !important;margin: 0px !important;background-color:var(--SuMDWhite);padding-top:6px;border-radius:22px !important;width:100%;margin-left:12px !important;">
            ...
            isScrollingSuMRecentsFuncF3CS = setTimeout(function () {
                ...
                if (ThisPageScrollContaner.scrollTop > SuMLastScrollTop) {
                    if (SuMReadingModeIsApplyed == false) {
                        ...
                        MakeSuMFullNavDisa();
                        androidAPIs.ActivateFullScreenMode();
                        androidAPIs.SuMBTActNoTopNNoBottom();
                        document.getElementById('BottomStylingTDiv').style.height = '0px';
