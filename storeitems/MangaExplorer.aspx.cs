...
namespace SuM_Manga_V3.storeitems
{
    public partial class MangaExplorer : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            string ActivePath = epath + "\\storeitems\\" + MangaName + help0136 + ChapterX;
            ...
            if (System.IO.Directory.Exists(ActivePath) == true)
            {
                ...
                for (int i = 0; i < filePaths.Length; i++)
                {
                    ...
                    TheMangaPhotos.InnerHtml += "<img loading=" + x + " style=" + imgstyle + " src=" + deafultstartitems + MangaName + slash0 + ChapterX + slash0 + filename + " /><br/>"; //style=" + imgstyle + "
                }
                ...
                string NextCh = Request.QueryString["Chapter"];
                ...
                string chaptertocheckexsis = Request.QueryString["Chapter"];
                chaptertocheckexsis = NextChapterNum(chaptertocheckexsis);


                string managtocheckexsis = Request.QueryString["Manga"];
                ...
                if (System.IO.Directory.Exists(checkifitexsists) == false)
        ...
        public static string NextChapterNum(string cname)
        {
            ...
            int help0 = 5;
            int md = 0;
            for (int d = 0; d < pross.Length; d++)
            {
                if (pross[d] != 'c' && pross[d] != 'h')
                {
