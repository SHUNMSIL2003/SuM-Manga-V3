...
namespace SuM_Manga_V3.storeitems
{
    public partial class MangaExplorer : System.Web.UI.Page
    {
        ...
        //public string DetectedMangaNameMySql = string.Empty;
        ...
        protected void LoadMangaInfo()
        {
            ...
            string CurrM = string.Empty;
            CurrM = GetMangaNameMySql(MangaID);
        ...
        protected void LoadCommentsSectionNFBTN() //TMP!
        {
            ...
            {
                Comments.InnerHtml = "<p style=" + '"'.ToString() + "color:var(--SuMDBlackOP48);text-align:center;width:100%;text-align:center;margin-top:calc(35vh - 128px);" + '"'.ToString() + ">No comments yet</p>";
            }
        }
