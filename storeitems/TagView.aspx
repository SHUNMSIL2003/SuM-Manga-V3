...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <asp:ScriptManager ID="ScriptManager1" EnablePartialRendering="true" runat="server" EnablePageMethods="true">
        ...
        <div style="height:fit-content;max-height:80vh !important; width:100vw;overflow:scroll; background-color:#ffffff !important;" id="CategoryX" runat="server">
            <h2 id="TagType" runat="server" style="color:#000000;margin-left:8px;margin-bottom:-18px;">#</h2>
