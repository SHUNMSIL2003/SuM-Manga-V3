...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div id="SuMCreatorAddBTNContaner" style="position:fixed;height:fit-content;width:100%;z-index:997;bottom:142px;padding-bottom:0px;padding-right:12px;">
        <a onclick="SuMGoToThis('/SuMCreator/CreatorMangaPanel.aspx','var(--SuMThemeColorOP74)','add a manga','Creator');" style="width:fit-content;height:fit-content;padding:12px;background-color:rgb(255,255,255);color:rgb(255,255,255);border-radius:50%;width:54px;height:48px;padding:6px;padding-left:9px;padding-right:9px;float:right;margin-bottom:4px;" class="shadow-sm animated fadeInUp">
