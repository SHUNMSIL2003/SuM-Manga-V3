...
namespace SuM_Manga_V3
{
    public partial class Library : System.Web.UI.Page
    {
        ...
        public string ContantShow(string MangaName, string MangaInfo, int MangaViews, string MangaCoverLink, string CExplorerLink, int ChaptersNum, int id)
        {
            ...
            string figurestyle = "margin-left:2.6px;margin-right:2.6px;margin-top:3px;width:30vw;height:45vw;max-width:156px;max-height:234px;border-radius:12px;border-top-left-radius:12px;border-bottom-right-radius:12px;border:-2px solid #6840D9;";
            string astyle = "border-radius:12px;margin:6px;width:34vw;max-width:164px;";//mw
            ...
            string divfits = "<div data-bss-hover-animate="+"pulse"+" style=" + "display:inline-block; height:fit-content;width:32vw;max-width:160px;" + ">";//mw
