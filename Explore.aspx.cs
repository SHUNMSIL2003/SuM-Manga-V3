...
namespace SuM_Manga_V3
{
    public partial class Explore : System.Web.UI.Page
    {
        ...
        protected string BuildCard(string CardBG, string cardtitle, string discr0, string Link, string theme)
        {
            ...
            string result = "<div class=" + divclass + " style=" + divstyle + "><a onclick=" + b12.ToString() + "fetch('" + Link + "', { method: 'GET' }).then(res => {location.href = '" + Link + "';}).catch(err => { location.href = '/SuMOffline.html'; })" + b12.ToString() + " ><br><h1 style=" + h1style + ">" + cardtitle + "</h1><br><p style=" + pstyle + ">" + discr + "</p></a></div>";
            return result;
        }/*
        ...
        protected string BuildGCard(string CardBG, string cardtitle, string G, string Link, string theme, int id)
        {
            ...
            string result = "<div class=" + zoominanim + " style=" + divs0 + "><a onclick=" + b12.ToString() + "fetch('" + Link + "', { method: 'GET' }).then(res => {location.href = '" + Link + "';}).catch(err => { location.href = '/SuMOffline.html'; })" + b12.ToString() + " style=" + as0 + "><div style=" + divs1 + "><div class=" + "GoodBlur" + " style=" + divs2 + "><p style=" + ps0 + ">" + cardtitle + "</p></div></div><p style=" + ps1 + ">" + GetGarnas(id) + "</p></a></div>"; //GetGarnas(id)
            return result;
        }
    }
}