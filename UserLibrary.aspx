...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
   ...
   <div class="animated slideInUp" id="ShowReqContantContaner" style="animation-duration:0.96s !important;background-color:#ffffff !important;height:fit-content !important;overflow-y:scroll !important;overflow-x:clip;border-top-left-radius:22px;border-top-right-radius:22px;margin-top:68px !important;padding-top:12px;padding-left:6px;padding-right:6px;padding-bottom:116px !important;min-height:calc(100vh - 76px) !important;" >
