...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    <div style="width:100vw;height:36px;background-color:rgb(242,242,242);text-align:center;padding-top:6px;padding-bottom:2px;">
    ...
    <div id="ShowReqContant" runat="server">
    </div>
</asp:Content>