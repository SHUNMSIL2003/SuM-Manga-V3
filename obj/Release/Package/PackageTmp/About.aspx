...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <h1 style="color:var(--SuMThemeColor)">   About Shun Manga "SuM".</h1><br />
    ...
    <br/>
    <a class="btn btn-primary btn-sm" style="background-color:var(--SuMThemeColor);" data-bss-hover-animate="pulse" href="Contact.aspx">CONTACT US &raquo;</a>
    </div></div>
</asp:Content>