...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    <!-- <a onclick="let timer; this.onpointerdown = function () { timer = setTimeout(alert, 1000, 'you held me down for 1 second'); } this.onpointerup = function () { clearTimeout(timer); }" style="background-color:var(--SuMDGray);width:fit-content;height:fit-content;">Click Me</a>
    <script>
    ...
    <div id="SuMUltraInfoCard" style="-webkit-transition: all 0.18s; -moz-transition: all 0.18s; -ms-transition: all 0.18s; -o-transition: all 0.18s; transition: all 0.18s;width:100%;height:fit-content;background-color:var(--SuMDWhite);margin:0 auto;border-top-right-radius:22px;border-top-left-radius:22px;position:fixed;z-index:995;bottom:108px;display:none;" class="animated slideInUp shadow-sm">
        <div id="SuMUltraBGColor" style="-webkit-transition: all 0.18s; -moz-transition: all 0.18s; -ms-transition: all 0.18s; -o-transition: all 0.18s; transition: all 0.18s;width:100%;height:fit-content;background-color:rgba(135,56,65,0.74);margin:0 auto;padding:20px;padding-top:0px;">
            <div style="width:100%;height:fit-content;padding-top:16px;padding-right:0px;">
                <a style="width:fit-content;height:fit-content;padding:3px;background-color:var(--SuMDWhiteOP18);border-radius:50%;margin-left:calc(100% - 30px);display:block;">
                    <svg xmlns="http://www.w3.org/2000/svg" height="22px" viewBox="0 0 24 24" width="24px" fill="var(--SuMDWhiteOP86)"><path d="M0 0h24v24H0V0z" fill="none"></path><path d="M18.3 5.71c-.39-.39-1.02-.39-1.41 0L12 10.59 7.11 5.7c-.39-.39-1.02-.39-1.41 0-.39.39-.39 1.02 0 1.41L10.59 12 5.7 16.89c-.39.39-.39 1.02 0 1.41.39.39 1.02.39 1.41 0L12 13.41l4.89 4.89c.39.39 1.02.39 1.41 0 .39-.39.39-1.02 0-1.41L13.41 12l4.89-4.89c.38-.38.38-1.02 0-1.4z"></path></svg>
                </a>
            </div>
            <div class="animated fadeIn;" style="-webkit-transition: all 0.18s; -moz-transition: all 0.18s; -ms-transition: all 0.18s; -o-transition: all 0.18s; transition: all 0.18s;width:100%;height:fit-content;">
                ...
                <div style="-webkit-transition: all 0.18s; -moz-transition: all 0.18s; -ms-transition: all 0.18s; -o-transition: all 0.18s; transition: all 0.18s;width:calc(70% - 20px);height:fit-content;display:inline-block;display:table-cell;vertical-align:middle;">
                    <h2 id="SuMUltarTitle" style="color:var(--SuMDWhite);height:fit-content;width:100%;margin-bottom:-2px;">#T</h2>
                    <div style="width:100%;height:fit-content;">
                        <p id="SuMUltarProdYear" style="width:fit-content;height:fit-content;color:var(--SuMDWhiteOP64);display:inline;margin-right:6px;font-size:86%;">#Y</p>
                        <p id="SuMUltraAgeRating" style="width:fit-content;height:fit-content;color:var(--SuMDWhiteOP64);display:inline;font-size:86%;">#A</p>
                        <p id="SuMUltarChptersNum" style="width:fit-content;height:fit-content;color:var(--SuMDWhiteOP64);display:inline;margin-left:6px;font-size:86%;">#CN</p>
                    </div>
                    <p id="SuMUltraMDisc" style="-webkit-transition: all 0.18s; -moz-transition: all 0.18s; -ms-transition: all 0.18s; -o-transition: all 0.18s; transition: all 0.18s;width:100%;height:fit-content;color:var(--SuMDWhiteOP86);padding:2px;font-size:74%;">#DSC</p>
                </div>
            </div>
            <hr class="animated fadeIn" style="margin:0 auto !important;height:2px;border-radius:1px;border-width:0;color:var(--SuMDWhite);background-color:var(--SuMDWhite);width:86%;opacity:0.12;margin:0px;margin-block:0px;margin-top:2px !important;margin-bottom:12px !important;">
            <div class="animated fadeIn" style="width:100%;height:fit-content;text-align:center !important;display:flex;align-items:center;justify-content:center;padding-bottom:8px;">
                <a style="display:inline-block !important;width:fit-content;height:fit-content;flex:1 1 auto;">
                    <div id="SuMUltraStartReadingFuncClick" style="-webkit-transition: all 0.18s; -moz-transition: all 0.18s; -ms-transition: all 0.18s; -o-transition: all 0.18s; transition: all 0.18s;width:fit-content;height:fit-content;padding:9px;border-radius:50%;background-color:var(--SuMDWhite);margin:0 auto;">
                    ...
                    <p id="SuMUltraCurrReadingTXT" style="width:fit-content;height:fit-content;color:var(--SuMDWhiteOP92);margin:0 auto;font-size:86%;">Loading</p>
                </a>
                <a style="display:inline-block !important;width:fit-content;height:fit-content;flex:1 1 auto;">
                    <div id="SuMUltraWannaListClick" style="-webkit-transition: all 0.18s; -moz-transition: all 0.18s; -ms-transition: all 0.18s; -o-transition: all 0.18s; transition: all 0.18s;width:fit-content;height:fit-content;padding:6px;border-radius:50%;background-color:var(--SuMDWhite);margin:0 auto;">
                ...
                <a style="display:inline-block !important;width:fit-content;height:fit-content;flex:1 1 auto;">
                    ...
                    <p style="width:fit-content;height:fit-content;color:var(--SuMDWhiteOP92);margin:0 auto;font-size:86%;">Fav</p>
                </a>
            </div>
            <hr class="animated fadeIn" style="margin:0 auto !important;height:2px;border-radius:1px;border-width:0;color:var(--SuMDWhite);background-color:var(--SuMDWhite);width:86%;opacity:0.12;margin:0px;margin-block:0px;margin-top:0px !important;margin-bottom:12px !important;">
            <div class="animated fadeIn" style="width:100%;height:fit-content;margin:0 auto;padding:8px;padding-bottom:8px;">
                <a id="SuMUltraHerfFuncLTE" onclick="return false;" style="width:fit-content;height:fit-content;margin:0 auto;text-align:center !important;display:block;margin:0 auto;padding:12px;">
                    <p id="UltraExploreOrLogIn" style="color:var(--SuMDWhiteOP96);font-size:98%;display:inline-block;width:fit-content;margin-left:12px;">manga explorer</p>
