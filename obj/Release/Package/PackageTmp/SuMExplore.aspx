<%@ Page Language="C#" MasterPageFile="~/SuMManga.Mobile.Master" AutoEventWireup="true" CodeBehind="SuMExplore.aspx.cs" Inherits="SuM_Manga_V3.SuMExplore" %>
                ...
                <ContentTemplate>
                    <asp:Panel runat="server">
                        <div id="RecentsSuperCont" runat="server" style="display:block;">
                            ...
                            <p style="font-size:132%;height:fit-content;width:calc(100% - 50px) !important;color:var(--SuMThemeColorOP74);float:left !important;word-wrap:break-word;white-space:pre-wrap;word-break:break-word;text-align:center;overflow: hidden;text-align:center !important;display:block !important;margin-bottom:7px !important;text-align:left !important;margin-top:28px !important;">Recently viewed </p>
                            <div id="RescentBody" runat="server" style="height:132px!important; width:calc(100% - 24px);overflow:hidden;border-radius:16px;background-color:var(--SuMThemeColorOP74) !important;margin:0 auto !important;padding:18px;padding-left:4px;margin-top:2px !important;overflow-x:scroll !important;overflow-y:hidden !important;">
