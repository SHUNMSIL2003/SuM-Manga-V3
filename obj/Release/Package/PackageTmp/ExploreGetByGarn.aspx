...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <asp:UpdatePanel ID="RESENTSUPATEPANLE" runat="server" UpdateMode="Conditional" style="width:fit-content;height:fit-content;float:left !important;margin-left:0px !important;">
        <Triggers>
            <asp:AsyncPostBackTrigger ControlID="UPDATERESESNTS" EventName="Click" />
        </Triggers>
            <ContentTemplate>
                <asp:Panel runat="server" style="width:100vw !important;height:100vh !important;float:left !important;margin-left:0px !important;">
                    <div style="height:100vh !important;max-height:100vh !important;width:100vw !important;overflow:hidden;display:block !important;border-radius:0px !important;padding-left:0px !important;">
