<%@ Page Language="C#" MasterPageFile="~/SuMManga.Mobile.Master" AutoEventWireup="true" CodeBehind="UserLibrarybu.aspx.cs" Inherits="SuM_Manga_V3.UserLibrarybu" %>
...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div id="ThisPageSBarFixUpPropElm" style="background-color:transparent !important;width:100vw;height:100vh;padding-top:24px !important;">
    <div id="LibraryTopPartHeightValueHelper" style="height:fit-content;width:100%;margin:0 auto !important;background-color:transparent !important;">
        <div id="LibCatTopPart" runat="server" class="animated fadeIn" style="animation-duration:0.32s !important;width:100vw;height:fit-content;background-color:transparent !important;text-align:center;padding-top:6px;padding-bottom:2px;position:fixed !important;padding-top:0px !important;">
            <div style="width:fit-content;height:fit-content;background-color:var(--SuMDWhiteOP74);border:2px solid var(--SuMDWhiteOP86);border-radius:23px;margin:0 auto !important;padding-top:3px;padding-bottom:3px;padding-left:8px;padding-right:8px;text-align:center;margin-top:8px !important;">
            ...
            <div class="animated fadeIn" id="infocard" runat="server" style="margin:0 auto;padding:22px !important;animation-duration:0.32s !important;width:100vw;height:fit-content;margin-top:16px;margin-bottom:18px;display:block !important;position:relative !important;z-index:999 !important;max-width:720px !important;background-color:transparent !important;">
                <svg id="InfoIMG" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" style="width:86px;height:86px;float:left;margin-top:0px !important;margin-left:18px;margin-left:-8px !important;display:block !important;" fill="var(--SuMDBlackOP64)"><path d="M0 0h24v24H0V0z" fill="none"/><path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm0 15c-.55 0-1-.45-1-1v-4c0-.55.45-1 1-1s1 .45 1 1v4c0 .55-.45 1-1 1zm1-8h-2V7h2v2z"/></svg>
                <p id="InfoAboutC" runat="server" style="padding-left:4px !important;padding-right:20px !important;padding-top:8px;width:calc(100% - 126px) !important;display:inline;height:fit-content;color:var(--SuMDBlackOP64) !important;font-size:78%;text-align:center !important;">DESC</p>
            </div>
        </div>
    </div>
   <div runat="server" class="animated fadeInUp" id="ShowReqContantContaner" style="margin:0 auto !important;margin-top:206px !important; overflow-x: clip; border-radius: 20px; padding-top: 12px; padding-left: 6px; padding-right: 6px; animation-duration: 0.96s !important; background-color: var(--SuMDWhiteOP86) !important;overflow-y: scroll !important;height:calc(100vh - 386px); max-width: 720px !important; position: relative !important;width:calc(100% - 24px);margin-left:12px;border:0.5px var(--SuMDBroderC) solid !important;" >
