<%@ Page Language="C#" MasterPageFile="~/SuMManga.Mobile.Creator.Master" AutoEventWireup="true" CodeBehind="CreatorPanel.aspx.cs" Inherits="SuM_Manga_V3.SuMCreator.CreatorPanel" %>
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div id="SuMLoadingPIndHandler" class="" style="overflow:hidden !important;border-radius:0px;display:block;position:fixed !important;top:0 !important;z-index:998 !important;background-color:#ffffff;width:100%;height:100%;margin-top:0px;margin-left:0px;-webkit-transition: all 0.5s; -moz-transition: all 0.5s; -ms-transition: all 0.5s; -o-transition: all 0.5s; transition: all 0.5s;">
        <div id="SuMLoadingFHandBG" runat="server" style="overflow:hidden !important;width:100%;height:100%;background-color:rgba(104,64,217,0.74);margin:0 auto;">
            <div id="SuMLoadingHandDivConF0C0" style="transition:all 0.18s !important;display: block; height: fit-content; width: 280px; background-color: rgb(255, 255, 255); border-radius: 18px; margin-right: auto; margin-bottom: 0px; padding: 38px 32px 32px; margin-left: calc(50vw - 140px); position: fixed !important; top: 0px !important; z-index: 1999 !important; margin-top: calc(50vh - 120px) !important; text-align: center !important;-webkit-transition: all 0.5s; -moz-transition: all 0.5s; -ms-transition: all 0.5s; -o-transition: all 0.5s; transition: all 0.5s;" class="shadow-sm">
                ...
                <p id="SuMLoadingHandlerTXT" runat="server" style="display: inline-block; margin-left: 4px; white-space: nowrap; overflow: hidden; text-overflow: ellipsis; font-size: 132%; color: rgba(104,64,217, 0.92); margin-bottom: -8px; text-align: left; width: calc(100% - 64px) !important;">Creator panel</p>
    ...
    <div id="CreatorInfoCard" class="animated fadeInDown shadow-sm" style="width:100%;height:fit-content;background-color:#ffffff;position:fixed !important;top:0 !important;z-index:998 !important;border-bottom-left-radius:20px;border-bottom-right-radius:20px;">
        ...
        <div style="width:calc(100% - 120px) !important;height:fit-content;min-height:86px;display:inline-block;padding:12px;margin:0 auto;padding-top:32px;">
            <p style="font-size:130%;color:rgba(0,0,0,0.82);" id="CreatorNameElm" runat="server">Creator Name</p>
            <p style="font-size:98%;color:rgba(0,0,0,0.74);" id="CreatorEmailElm" runat="server">Creator Email</p>
        </div>
    </div>
    <asp:Button style="display:none !important;visibility:hidden !important;" ID="UpdateContantETN" runat="server" OnClick="Page_Load" />
    <div id="CreatorContantContaner" class="animated fadeIn" style="height:100%;width:100%;padding:0px;padding-top:120px;background-color:rgba(104,64,217,0.92);margin:0 auto !important;">
    ...
    <div id="SuMCreatorAddBTNContaner" style="position:fixed;height:fit-content;width:100%;z-index:997;bottom:142px;padding-bottom:0px;padding-right:12px;">
        <a onclick="SuMGoToThis('/SuMCreator/CreatorMangaPanel.aspx','rgba(104,64,217,0.74)','add a manga','Creator');" style="width:fit-content;height:fit-content;padding:12px;background-color:rgb(255,255,255);color:rgb(255,255,255);border-radius:50%;width:54px;height:48px;padding:6px;padding-left:9px;padding-right:9px;float:right;margin-bottom:4px;" class="shadow-sm animated fadeInUp">
