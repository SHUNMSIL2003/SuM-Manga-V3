...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div id="LibCatTopPart" class="animated fadeIn" style="animation-duration:0.32s !important;width:100vw;height:fit-content;background-color:rgb(242,242,242);text-align:center;padding-top:6px;padding-bottom:2px;position:fixed !important;">
        ...
        <div class="animated fadeIn" id="infocard" style="margin:0 auto;padding:22px !important;animation-duration:0.32s !important;width:100vw;height:fit-content;margin-top:16px;margin-bottom:18px;display:block !important;position:relative !important;z-index:999 !important;max-width:720px !important;">
   ...
   <div class="animated slideInUp" id="ShowReqContantContaner" style="margin:0 auto;animation-duration:0.96s !important;background-color:#ffffff !important;height:fit-content !important;overflow-y:scroll !important;overflow-x:clip;border-top-left-radius:22px;border-top-right-radius:22px;margin-top:68px !important;padding-top:12px;padding-left:6px;padding-right:6px;padding-bottom:116px !important;min-height:calc(100vh - 76px) !important;max-width:720px !important;" >
        ...
        <script>
            document.getElementById('ShowReqContantContaner').style.marginTop = document.getElementById('LibCatTopPart').offsetHeight + 'px';
