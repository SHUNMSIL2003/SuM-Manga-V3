...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    <div style="width:100%;height:84px;text-align:center;background-color:rgb(242,242,242);">
        <a id="upl" runat="server" style="color:#6840D9;margin-left:12px;">Uploads</a>
    ...
    <div style="text-align:center;width:100%;height:fit-content;">
        <a id="ADDB" runat="server" href="#" style="background-color:#6840D9;color:#ffffff;border-radius:16px;height:fit-content;width:fit-content;font-size:160%;"><b>+</b></a>
    </div>
</asp:Content>