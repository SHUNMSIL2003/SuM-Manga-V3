...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div style="background-color:rgba(242,242,242,0.82) !important;width:100% !important;height:24px;position:fixed !important;top:0 !important;z-index:997 !important;" id="SuMSettingStatausBarHelperF000C000"></div>
        ...
        <div id="SUAC000SP" class="animated zoomIn card shadow-sm" style="margin:0 auto !important;max-width:382px !important;animation-duration:0.28s !important;width:fit-content;height:fit-content;padding:6px;border-radius:18px;background-color:#ffffff;vertical-align:middle !important;margin-top:calc(50vh - 106px) !important;">
            ...
            <div style="text-align:center;margin-top:16px;">
                <a onclick="document.getElementById('MainContent_SettingsUnavaliblePOPUP').style.display = 'none';" class="btn" style="margin:0 auto !important;background-color:rgb(104,64,217);color:#ffffff;border-radius:12px;width:fit-content;height:fit-content;padding-top:5px;padding-bottom:5px;padding-left:20px;padding-right:20px;margin-bottom:8px !important;">OK</a>
                        ...
                        <div id="SuMRnadomScrollHelper" style="scroll-snap-type: y mandatory;height:100vh;width:100vw; padding:0px !important;padding-top:0px !important;padding-bottom:8px !important; background-color:#f2f2f2 !important;margin:0 auto !important; margin-top:0px !important;">
    ...
    <div id="SlideDownCard" runat="server" style="animation-duration:0.26s !important;width:calc(100% - 24px); padding:0px !important;padding-top:8px !important;padding-bottom:8px !important; background-color:rgb(255,255,255) !important;margin:0 auto !important;margin:12px !important;border-radius:20px !important;padding:0px !important;margin-bottom:0px !important;border:0.5px #dfdfdf solid !important;" class="animated slideInDown">
        ...
        <div id="ThisPageMaxNoShowScrool" runat="server" style="background-color:rgba(104,64,217,0.74) !important;border-radius:20px !important;width:100%;margin:0 auto !important;padding:16px !important;margin-top:0px !important; margin-bottom:0px !important;z-index:998;position:relative;">
            ...
            <div style="width:86px;height:86px;border-radius:50%;background-color:rgb(255,255,255);border:2px solid rgb(255,255,255) !important;float:left;display:inline;margin-bottom:4px;padding:0px !important;">
                ...
                <div id="UserInfoDiv" runat="server" class="fadeIn animated" style="float:left;display:inline;margin-left:8px;padding-top:12px !important;width:calc(100% - 94px) !important;">
                    ...
                    <h6 id="SignedWith" runat="server" style="color:rgb(255,255,255,0.86);font-size:74%;margin-left:12px;width:fit-content;max-width:100% !important;white-space:nowrap !important;overflow:hidden;text-overflow:ellipsis !important;"></h6>
                </div>
            </a>
        ...
        <div runat="server" id="UserSettingsCards" class="" style="display:block;height:0px;overflow:hidden;transition: height 0.4s;background-color:#ffffff;padding:0px;">
            ...
            <div style="width:100% !important;height:100% !important;background-color:#ffffff !important;">
                        ...
                        <div style="padding-top:0px !important;padding-bottom:0px !important;background-color:#ffffff !important;margin-top:0px !important;width:100vw;height:fit-content;">
                                <div onclick="SuMSettingDivExpandor('PFPDiv');" class="card-header py-3" style="background-color:#ffffff !important;position:relative;z-index:997;display: flex; align-items: center;flex-direction: row;height:54px;overflow:hidden;border:none;">
                                    ...
                                    <p style="color:#000000 !important;display:inline;float:left;margin:8px;">Change profile Pic & Banner</p>
                                </div>
                                <div id="PFPDiv" runat="server" class="card-body text-center animated slideInDown" style="animation-duration: 0.4s !important;background-color:#ffffff !important;display:none;height:fit-content;position:relative;z-index:996;width: calc(100% - 32px);">
                ...
                <div style="padding-top:0px !important;padding-bottom:0px !important;background-color:#ffffff !important;margin-top:0px !important;display:none !important;">
                    <hr style="margin:0 auto !important;height:2px;border-radius:1px; border-width:0;color:rgb(0,0,0);background-color:rgb(0,0,0);width:calc(100% - 64px);opacity:0.06;margin:0px;margin-block:0px;margin:0 auto !important;"/>
            ...
            <hr style="margin:0 auto !important;height:2px;border-radius:1px; border-width:0;color:rgb(0,0,0);background-color:rgb(0,0,0);width:calc(100% - 64px);opacity:0.06;margin:0px;margin-block:0px;margin:0 auto !important;"/>
                    ...
                    <div class="" style="background-color:#ffffff !important;">
                        ...
                        <div id="CreatorClick" runat="server" style="border:none;height:54px;overflow:hidden;background-color:#ffffff !important;position:relative;z-index:997;display: flex; align-items: center;flex-direction: row;" onclick="SuMSettingDivExpandor('creatorsupmitform');" class="card-header py-3">
                            <img src="/svg/CreatorPanel.svg" style="width:26px;height:26px;display:inline;float:left;" />
        ...
        <div id="StartSetAnim" runat="server" class="fadeIn animated" style="width:calc(100% - 24px) !important;height:fit-content;background-color:rgb(255,255,255) !important;border-radius:20px !important;padding: 20px !important;margin-top:12px !important;margin:12px !important;padding-top:32px !important;border:0.5px #dfdfdf solid !important;">
            ...
            <div style="vertical-align:middle;display:block !important;">
                                    <svg style="display:inline;float:left;" xmlns="http://www.w3.org/2000/svg" height="30px" viewBox="0 0 24 24" width="30px" id="SuMLockIcon" fill="#231f20"><g fill="none"><path d="M0 0h24v24H0V0z"/><path d="M0 0h24v24H0V0z" opacity=".87"/></g><path d="M18 8h-1V6c0-2.76-2.24-5-5-5S7 3.24 7 6v2H6c-1.1 0-2 .9-2 2v10c0 1.1.9 2 2 2h12c1.1 0 2-.9 2-2V10c0-1.1-.9-2-2-2zm-6 9c-1.1 0-2-.9-2-2s.9-2 2-2 2 .9 2 2-.9 2-2 2zM9 8V6c0-1.66 1.34-3 3-3s3 1.34 3 3v2H9z"/></svg>
                                    <p style="color:#000000;display:inline;float:left;margin:8px;font-size:112%;margin-top:4px;">SuM Lock</p>
